...
<?php 
		...
		if (0) {//$widgetEdit = $field->widgetEdit($profile)
			...
			echo $form->textAreaRow($profile,$field->varname,array('rows'=>6, 'cols'=>50));
			   ...
			   echo $form->datepickerRow($profile, $field->varname,
        array('options'=>array('format' => 'yyyy-mm-dd'),'hint'=>'birthday.', 'prepend'=>'<i class="icon-calendar"></i>')); 
...
<?php $this->widget('bootstrap.widgets.TbButton', array('buttonType'=>'submit', 'label'=>$model->isNewRecord ? UserModule::t('Create') : UserModule::t('Save'))); ?>
<?php $this->endWidget();
